...
class DataNotFoundExceptionTest {
    @Test
    void testConstructor_withNoDetailMessage_shouldCreateExceptionWithoutMessage_ok() {
        // Arrange & Act
    ...
    @Test
    void testConstructor_withDetailMessage_shouldCreateExceptionWithMessage_ok() {
        // Arrange
